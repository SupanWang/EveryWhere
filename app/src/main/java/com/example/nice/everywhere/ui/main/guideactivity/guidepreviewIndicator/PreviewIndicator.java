package com.example.nice.everywhere.ui.main.guideactivity.guidepreviewIndicator;
...
import com.example.nice.everywhere.util.SystemUtil;
...
public class PreviewIndicator extends LinearLayout {
    ...
    //选中时对应指示器点的宽度
    private int chooseSize = 70;//80
    //未选中时指示器点的宽度
    private int nomalSize = 28;//32
    //指示器高度
    private int height = 5;//10
