...
public class BanmiDetsilAdapter extends RecyclerView.Adapter<BanmiDetsilAdapter.ViewHolder> {

    //    CenkLIenter cenkLIenter;
    private ArrayList<BanMiDetailBean.ResultBean.BanmiBean> list = new ArrayList<>();
    ...
    public void update(List<BanMiDetailBean.ResultBean.BanmiBean> list , List<BanMiDetailBean.ResultBean.ActivitiesBean> activitiesBeans) {
        this.list.clear();
